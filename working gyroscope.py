...
while True:
    ...
    # forces[0] = vector(0, -m * g, 0) + springForce(center_spring[0].obj.axis, L1) - springForce(
    #     connect_spring[0].obj.axis, L2) + springForce(
    #     connect_spring[2].obj.axis, L2)
    # forces[1] = vector(0, -m * g, 0) + springForce(center_spring[1].obj.axis, L1) - springForce(
    #     connect_spring[1].obj.axis, L2) + springForce(
    #     connect_spring[0].obj.axis, L2)
    # forces[2] = vector(0, -m * g, 0) + springForce(center_spring[2].obj.axis, L1) - springForce(
    #     connect_spring[2].obj.axis, L2) + springForce(
